 ...
 */
final class Version20220118122904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE space (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, name VARCHAR(100) NOT NULL, photo VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, surface INT NOT NULL, category VARCHAR(50) NOT NULL, capacity INT NOT NULL, location VARCHAR(500) NOT NULL, price INT NOT NULL, description LONGTEXT DEFAULT NULL, address VARCHAR(255) NOT NULL, availability LONGTEXT NOT NULL, INDEX IDX_2972C13A7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
